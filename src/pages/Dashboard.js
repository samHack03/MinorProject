...
export default function FamilyApartments() {
  ...
  <div className="sk-cube sk-cube9"></div>
      ...
      <Link to="/medium-tools" class="text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900" style={{marginTop:"150px"}}>View More</Link>
      ...
      <Link to="/small-tools" class="text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900" style={{marginTop:"150px"}}>View More</Link>
      {/* <button type="button" >Green</button> */}
        </div>
