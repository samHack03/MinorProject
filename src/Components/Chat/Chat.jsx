...
<h4 className="font-bold text-2xl flex justify-center  uppercase text-green-800" style={{marginTop:"50px", marginLeft:"20px"}}>Chat With Owner</h4>
      ...
      <div class="flex-1 p:2 sm:p-6 justify-between  flex-col h-screen w-1/2">
      ...
      <div class="relative flex items-center space-x-4">
         ...
         <div class="flex flex-col leading-tight">
            <div class="text-2xl mt-1 flex items-center">
               <span class="text-gray-700 mr-3">Kartikay</span>
            </div>
            <span class="text-lg text-gray-600">Equipment Owner</span>
         </div>
      </div>
