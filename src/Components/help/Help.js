...
const Help = () => {
  const booking_help = [
    {
      heading: "Q: How do I book an equipment on Krish-e-Hal",
      content:
  ...
  return (
    <div className="" style={{width:"100%"}}>
      ...
      <div style={{width:"70%", height:"60%"}} className="bg-white rounded-2xl mx-auto w-11/12 p-9 -translate-y-8 flex justify-center shadow-lg">
